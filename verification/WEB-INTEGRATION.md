...
- `npm run build` 通过。网页离线包 817 文件、33.8 MiB。壁纸构建（`npm run build:wallpaper`，824 文件、35.1 MiB）已于 2026-09-24 随 Wallpaper Engine 支持移除。保留 Vite 既有大包提示。
...
- 网页 manifest 和生成的 Service Worker 存在；壁纸输出已于 2026-09-24 移除。本轮未重新执行完整离线升级故障矩阵。
